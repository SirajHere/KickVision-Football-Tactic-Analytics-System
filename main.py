...
def main():
    # Read Video
    video_frames = read_video("d:/major 2/input_videos/match.mp4")

    # Initialize Tracker
    tracker = Tracker("d:/major 2/models/best.pt")
    ...
    # Save video
    save_video(output_video_frames, "d:/major 2/output_videos/output_video.avi")
